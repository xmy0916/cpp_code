...
CmfctestDlg * CmfctestDlg::s_pDlg = nullptr;
...
BEGIN_MESSAGE_MAP(CmfctestDlg, CDialogEx)
	...
	ON_STN_CLICKED(IDC_ColorImage, &CmfctestDlg::OnStnClickedColorimage)
END_MESSAGE_MAP()
...
void CmfctestDlg::OnTimer(UINT_PTR nIDEvent)     //定时器处理
{
	switch (nIDEvent)
	{
	case 35:
...
void CmfctestDlg::OnStnClickedColorimage()
{
	// TODO: 在此添加控件通知处理程序代码
}
